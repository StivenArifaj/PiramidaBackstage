...
CRITICAL INSTRUCTION: When you call a tool and receive data back, YOU MUST explicitly summarize the results in your text response. NEVER say 'I found the information' without actually listing the data, names, capacities, or metrics returned by the tool.
