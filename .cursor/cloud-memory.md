...
- **Phase:** Phase 12 complete — Space Kill Switch: admin can disable/re-enable individual spaces from dashboard; client booking form fully locked out for maintenance spaces; events API hard-blocks 403.
