...
- **Phase:** Phase 13 complete — All dashboard BI (Reports, Inventory, Maintenance) now query live Supabase data exclusively. Zero mock data in production paths. `npx tsc --noEmit` clean.
