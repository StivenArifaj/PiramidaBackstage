    ...
    <div style={{ minHeight: '100vh', backgroundColor: 'var(--color-concrete-char)' }}>
      ...
      <div style={{ paddingTop: '48px', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', minHeight: '100vh', padding: '80px 64px' }}>
        ...
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 2.5 }}
          ...
          <Link href={`/track/${ref}`} style={{ fontFamily: 'var(--font-display)', fontSize: '11px', fontWeight: 500, letterSpacing: '0.14em', textTransform: 'uppercase', textDecoration: 'none', color: 'var(--color-lime-ink)', backgroundColor: 'var(--color-lime)', padding: '14px 32px' }}>
            track my booking
          </Link>
